...
const requester = function requester(options) {
  ...
  return new Promise((resolve, reject) => {
    ...
    if (exists(data)) {
      // if method is GET and Content-Type application/x-www-form-urlencoded
      // we recompose request path by adding both query and data query at the end
      if (requestOptions.method === 'GET'
        ...
        requestOptions.path = `${pathname}?${queryData}`;
        body = defaults.body;
    ...
    debug('request options: ', { ...requestOptions, body });
